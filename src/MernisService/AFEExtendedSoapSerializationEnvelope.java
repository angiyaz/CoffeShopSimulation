...
public class AFEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(AFEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new AFEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static AFEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static AFEDateTimeConverter dateTimeConverter = new AFEStandardDateTimeConverter();

    public AFEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AFEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AFEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=AFEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,AFEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=AFEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
