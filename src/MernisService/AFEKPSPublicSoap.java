...
public class AFEKPSPublicSoap
{
    ...
    public AFEKPSPublicSoap(){}

    public AFEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public AFEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        AFEExtendedSoapSerializationEnvelope envelope= new AFEExtendedSoapSerializationEnvelope(AFEExtendedSoapSerializationEnvelope.VER11);
